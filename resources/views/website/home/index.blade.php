            ...
            <div class="row bg-info">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset($category->image)}}" alt="#" height="150">
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="row bg-info">
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-4 col-md-4  col-12">
                            ...
                            <div class="single-product">
                                <div class="product-image">
                                    <img src="{{asset($subCategory->image)}}" alt="#" height="100" width="100">
                                    <div class="button">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        ...
                        <div class="text">
                            <h2><a href="product-grids.html">HeadPhone</a></h2>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                            ...
                            <div class="price">
                                <span>3000</span>
                                <span class="discount-price">6000</span>
                            </div>

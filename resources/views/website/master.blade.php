                            ...
                            <div class="cart-items">
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{asset($cartItem->options->image)}}" alt="#" height="50"></a>
                                            </div>
                                            <div class="content">
                                                <h4><a href="product-details.html">{{$cartItem->name}}</a></h4>
                                                <p class="quantity">1x - <span class="amount">{{$cartItem->subtotal}}</span></p>
                                            </div>
                                        </li>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="button">
                                            <a href="{{route('product.checkout')}}" class="btn animate">Checkout</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a href="{{route('page-shipping')}}" >Shipping Policy</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('page-return')}}" >Return  Policy</a>
                                </li>
                                <li class="nav-item">

    ...
    <table cellpadding="0" cellspacing="0">
            ...
            <td colspan="4">
                <table>
                    <tr>
                        <td class="title">
                            <img
                                src="http://localhost/sabbir/fresh-app/public/website/assets/images/logo/logo.svg"
        ...
        @foreach($order->orderDetails as $orderDetail)
            <tr class="item">
                ...
                <td align="right">{{$total =$orderDetail->product_quantity*$orderDetail->product_price}}</td>
            </tr>
            @php($sum=$sum+$total)
        @endforeach
